<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="com.travishankarmishra.model.ProductModel"%>
...
List<ProductModel> data = (List<ProductModel>)request.getAttribute("data");
                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            ...
                            <li><a href="#"><%=categories.get(i) %></a></li>
                            <%} %>
                        </ul>
                    </div>
                </div>
    ...
    <section class="categories">
        <div class="container">
            <div class="row">
                ...
                { %>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="static/img/upload/<%=data.get(i).getImg_urls().get(0).getImageurl()  %>">
                            <h5><a href="#"><%=data.get(i).getName() %></a></h5>
                        </div>
                    </div>
                    <%} %>
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <% for(int i=0;i<categories.size();i++){ %>
                            <li data-filter=".<%=categories.get(i) %>"><%=categories.get(i) %></li>
                            <%} %>
